...
| Live status of this contract | **UNVERIFIED against a live send.** The version-2 shape was derived statically from the installed bundle and is covered by hermetic tests only; no send has been attempted on `26.901.1978.0` or on its successor `26.901.2854.0`. Delivery is claimed only once a live wrapper attempt has run and been certified independently |
