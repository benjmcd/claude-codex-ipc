...
Refuses $uninstall @('-DryRun','-Target',"\\localhost\c`$\dev\claude-codex-ipc\skills\ipc")  'backslash UNC'
Refuses $uninstall @('-DryRun','-Target',"//localhost/c`$/dev/claude-codex-ipc/skills/ipc")  'FORWARD-SLASH UNC'
Refuses $uninstall @('-DryRun','-Target',"\\127.0.0.1\c`$\dev\claude-codex-ipc\skills\ipc")  'UNC via 127.0.0.1'
...
Refuses $install @('-DryRun','-Force','-Target',"//localhost/c`$/dev/claude-codex-ipc/skills/ipc") 'install: forward-slash UNC'
