...
#
# Runs all DEFAULT_SUITES (currently twelve), tests/scan_public_safety.sh, and the static
...
#
# Usage:
#   run_release_gates.sh                 # all DEFAULT_SUITES (currently 12) + safety + contract audit
