...
#
# Runs all DEFAULT_SUITES (currently thirteen), tests/scan_public_safety.sh, and the static
...
#
# Usage:
#   run_release_gates.sh                 # all DEFAULT_SUITES (currently 13) + safety + contract audit
